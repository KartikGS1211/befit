    ...
    <div className="fitness-page">
      ...
      <main>
        ...
        <div className="grid-container">
          ...
          <Link to="/Bmi" ><button className="card-button">CALCULATE</button></Link>
          ...
          <Card title="DIET">
            ...
            <Link to="/Diet" ><button className="card-button">CLICK ME!</button></Link>
          </Card>
          ...
          <Card title="WORKOUT">
            ...
            <Link to="/Workout" ><button className="card-button">VIEW CONTENT</button></Link>
          </Card>
        </div>
        ...
        <div className="grid-container">
          <Card title="GOAL" >
            ...
            <Link to="/Goal" ><button className="card-button">START</button></Link>
          </Card>
          ...
          <Card title="PERSONAL TRAINING" >
            ...
            <Link to="/Training" ><button className="card-button">VIEW</button></Link>
          </Card>
